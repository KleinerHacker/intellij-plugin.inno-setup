...
/**
 * Tests that [org.pcsoft.intellij.plugin.inno_setup.preprocessor.language.parser.IsPreprocessorAnnotator] validates `#dim`/`#redim` arrays and array element `#define`s: array
