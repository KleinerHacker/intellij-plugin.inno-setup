...
import org.pcsoft.intellij.plugin.inno_setup.language.parser.section.psi.impl.IsSectionPreprocessorLineMixinImpl
import org.pcsoft.intellij.plugin.inno_setup.language.parser.template.psi.impl.IsTemplatePreprocessorLineMixinImpl
...
class IsPreprocessorHostWiringTest : TestCase() {
    ...
    fun testHostPreprocessorLinesImplementIsPreprocessorHostLine() {
        assertTrue("section preprocessor line must be an ISPP host line",
            IsPreprocessorHostLine::class.java.isAssignableFrom(IsSectionPreprocessorLineMixinImpl::class.java))
        assertTrue("template preprocessor line must be an ISPP host line",
