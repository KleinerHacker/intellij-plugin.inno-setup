...
/**
 * Tests the `#for {Init; Cond; Incr} Body` validation in [org.pcsoft.intellij.plugin.inno_setup.preprocessor.language.parser.IsPreprocessorAnnotator]: simple counting loops,
