 ...
 * parses into an [org.pcsoft.intellij.plugin.inno_setup.script.language.file_type.lang.IsLanguageFile] (which is also an [IsScriptFile], so all ISS tooling keeps working).
 */
