...
/**
 * Tests the `#sub` *usage* rules in [org.pcsoft.intellij.plugin.inno_setup.preprocessor.language.parser.IsPreprocessorAnnotator]: a subroutine may only be called as the body of a
