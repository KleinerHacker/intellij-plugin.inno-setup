...
/**
 * End-to-end tests of the #define expression analysis in [org.pcsoft.intellij.plugin.inno_setup.preprocessor.language.parser.IsPreprocessorAnnotator]: the six user-named
...
class IsPreprocessorExpressionAnnotatorTest : IsTimedBasePlatformTestCase() {
    ...
    fun testUserReferenceScriptHasNoExpressionErrors() {
        ...
        assertTrue(
            "User reference script must be free of expression errors: ${markedSlices(script)}",
