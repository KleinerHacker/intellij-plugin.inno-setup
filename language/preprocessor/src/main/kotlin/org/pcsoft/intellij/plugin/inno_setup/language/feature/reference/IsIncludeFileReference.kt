...
class IsIncludeFileReference(
    ...
    override fun resolve(): PsiElement? {
        ...
        val hostFile = injMgr.getTopLevelFile(element.containingFile).takeIf { it is IsPreprocessorHost } ?: return null
    ...
    override fun bindToElement(element: PsiElement): PsiElement {
        ...
        val hostFile = injMgr.getTopLevelFile(this.element.containingFile).takeIf { it is IsPreprocessorHost } ?: return this.element
