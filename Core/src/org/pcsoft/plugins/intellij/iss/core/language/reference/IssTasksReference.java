...
import org.pcsoft.plugins.intellij.iss.core.language.type.property.TasksPropertyType;
import org.pcsoft.plugins.intellij.iss.core.util.IssSearchForElementUtils;

import java.util.List;
import java.util.stream.Collectors;

public class IssTasksReference extends IssAbstractReference {
    public IssTasksReference(PsiNamedElement element, boolean strictSearch) {
    ...
    public ResolveResult[] multiResolve(boolean b) {
        final List<IssMultipleProperty> multipleProperties = IssSearchForElementUtils.searchForTasks(myElement.getProject(),
    ...
    public boolean isReferenceTo(PsiElement element) {
        if (element instanceof IssRefValue) {
            ...
            if (propertyType == null || propertyType != TasksPropertyType.Name)
                return false;
