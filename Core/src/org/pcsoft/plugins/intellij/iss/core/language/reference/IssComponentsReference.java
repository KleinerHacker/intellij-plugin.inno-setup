...
import org.pcsoft.plugins.intellij.iss.core.language.parser.psi.element.IssFile;
import org.pcsoft.plugins.intellij.iss.core.language.parser.psi.element.IssMultipleProperty;
...
import org.pcsoft.plugins.intellij.iss.core.language.type.property.ComponentsPropertyType;
import org.pcsoft.plugins.intellij.iss.core.util.IssSearchForElementUtils;

import java.util.List;
import java.util.stream.Collectors;

public class IssComponentsReference extends IssAbstractReference {
    public IssComponentsReference(PsiNamedElement element, boolean strictSearch) {
    ...
    public ResolveResult[] multiResolve(boolean b) {
        final List<IssMultipleProperty> multipleProperties = IssSearchForElementUtils.searchForComponents(myElement.getProject(),
    ...
    public boolean isReferenceTo(PsiElement element) {
        if (element instanceof IssRefValue) {
            ...
            if (propertyType == null || propertyType != ComponentsPropertyType.Name)
                return false;
