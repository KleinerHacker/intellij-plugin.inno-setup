...
import org.pcsoft.plugins.intellij.iss.core.language.parser.psi.element.IssPreprocessorValue;
...
public class SpecialValueTypeCheckAnnotator implements Annotator {
    ...
    public void annotate(@NotNull PsiElement psiElement, @NotNull AnnotationHolder annotationHolder) {
        if (psiElement instanceof IssProperty) {
            ...
            if (preprocessorType != org.pcsoft.plugins.intellij.iss.core.language.type.PreprocessorType.Define)
                return;
