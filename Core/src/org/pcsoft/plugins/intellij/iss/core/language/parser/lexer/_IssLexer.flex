...
import static org.pcsoft.plugins.intellij.iss.core.language.parser.IssCustomTypes.*;
import static org.pcsoft.plugins.intellij.iss.core.language.parser.IssGenTypes.*;
