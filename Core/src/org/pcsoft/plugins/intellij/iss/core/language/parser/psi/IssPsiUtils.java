...
import org.pcsoft.plugins.intellij.iss.core.language.parser.psi.element.*;
import org.pcsoft.plugins.intellij.iss.core.language.reference.IssComponentsReference;
import org.pcsoft.plugins.intellij.iss.core.language.reference.IssDefineSymbolReference;
...
import org.pcsoft.plugins.intellij.iss.core.language.type.PreprocType;
...
public interface IssPsiUtils {
    ...
    @Nullable
    static PreprocessorType getType(final IssPreprocessorType preprocessorType) {
        return PreprocessorType.fromName(preprocessorType.getText().substring(1));
    }
    //</editor-fold>

    //<editor-fold desc="Preprocessor Element">
    @Nullable
    static PreprocessorType getType(final IssPreprocessorElement preprocessorElement) {
