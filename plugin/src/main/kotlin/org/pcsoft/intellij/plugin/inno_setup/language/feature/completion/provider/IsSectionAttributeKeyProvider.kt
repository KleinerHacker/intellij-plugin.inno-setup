...
object IsSectionAttributeKeyProvider : CompletionProvider<CompletionParameters>() {
    ...
    override fun addCompletions(
        ...
        specSection.attributes.forEach { attr ->
            ...
            val attrSince = attr.since
            val attrUntil = attr.until
            val tooNew = minVersion != null && attrSince != null &&
                    IsSettingsService.compareIsVersions(attrSince, minVersion) > 0
            val removed = minVersion != null && attrUntil != null &&
                    IsSettingsService.compareIsVersions(attrUntil, minVersion) <= 0
