...
class IsiAnnotatorTest : BasePlatformTestCase() {
    ...
    fun testValidFlagHighlightedAsFlagColor() {
        ...
        val hit = all.any { it.forcedTextAttributesKey == IsiAnnotatorHighlighting.FLAG &&
    ...
    fun testKnownBuiltinConstantHighlightedAsReference() {
        ...
        val hit = all.any { it.forcedTextAttributesKey == IsiAnnotatorHighlighting.REFERENCE &&
    ...
    fun testPreprocessorIncludeKeywordHighlighted() {
        ...
        val all = myFixture.doHighlighting()
        val hit = all.any { it.forcedTextAttributesKey == IsiAnnotatorHighlighting.PREPROCESSOR_DIRECTIVE &&
