...
/**
 * Tests for [IssTypedHandler.checkAutoPopup] — the branches that decide whether
 ...
 */
class IssTypedHandlerTest : BasePlatformTestCase() {

    private val handler = IssTypedHandler()
