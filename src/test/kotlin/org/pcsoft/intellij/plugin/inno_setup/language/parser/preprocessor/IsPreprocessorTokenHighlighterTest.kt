...
class IsPreprocessorTokenHighlighterTest : IsTimedBasePlatformTestCase() {
    ...
    fun testNumberLiteralUsesNumberColor() {
        assertTrue(
            ...
            highlighter.getTokenHighlights(IsPreprocessorTypes.NUMBER)
    ...
    fun testQuotedStringUsesStringColor() {
        assertTrue(
            ...
            highlighter.getTokenHighlights(IsPreprocessorTypes.QUOTE)
                .contains(DefaultLanguageHighlighterColors.STRING)
        )
        assertTrue(
            "String content must use the STRING color",
            highlighter.getTokenHighlights(IsPreprocessorTypes.STRING_PART)
                .contains(DefaultLanguageHighlighterColors.STRING)
        )
    }
