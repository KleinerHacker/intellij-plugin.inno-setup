...
/**
 * Tests for [IsiSectionMover] — "Move Statement Up/Down" must swap whole ISS sections
 ...
 */
class IsiSectionMoverTest : BasePlatformTestCase() {

    private fun move(action: String, before: String, after: String) {
        myFixture.configureByText(IssFileType.INSTANCE, before)
