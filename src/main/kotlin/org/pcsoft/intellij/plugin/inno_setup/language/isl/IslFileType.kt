...
/**
 * File type for Inno Setup language files (`.isl`). Bound to the existing [IssLanguage] so all ISS
 ...
 */
class IslFileType private constructor() : LanguageFileType(IssLanguage) {
    companion object {
        @JvmField
        val INSTANCE = IslFileType()
    }
