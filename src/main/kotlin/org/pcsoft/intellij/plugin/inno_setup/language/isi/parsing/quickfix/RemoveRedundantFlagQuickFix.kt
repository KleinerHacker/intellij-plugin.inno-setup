 ...
 * [IsiParamValue], e.g. removing `nocompression` from `Flags: external nocompression`.
 */
class RemoveRedundantFlagQuickFix(value: IsiParamValue, private val flagText: String) : IntentionAction {
    ...
    private fun findFlagNode(): ASTNode? {
        ...
        return value.node.getChildren(TokenSet.create(IsiTypes.IDENTIFIER))
