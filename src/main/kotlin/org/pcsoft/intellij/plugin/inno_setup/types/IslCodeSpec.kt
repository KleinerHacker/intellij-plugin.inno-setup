...
data class IslLanguageSpec(
    ...
    val icon: Icon
        get() = flag?.let { IconLoader.getIcon("/icons/flags/$it.svg", IslLanguageSpec::class.java) }
...
data class IslCodeSpec(
    val languages: List<IslLanguageSpec>
)
