...
/**
 * Appends one or more required flag identifiers to a flags [IsiParamValue], e.g. adding
 ...
 */
class AddMissingFlagsQuickFix(value: IsiParamValue, private val requiredFlags: List<String>) : IntentionAction {
    ...
    override fun invoke(project: Project, editor: Editor?, file: PsiFile) {
        ...
        val lastFlag = value.node.getChildren(TokenSet.create(IsiTypes.IDENTIFIER)).lastOrNull()
    ...
    private fun missingFlags(): List<String> {
        ...
        val present = value.node.getChildren(TokenSet.create(IsiTypes.IDENTIFIER))
