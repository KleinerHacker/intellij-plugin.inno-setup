 ...
 */
public enum SectionCustomMessagesProperty implements SectionProperty {
    ;
    ...
    private SectionCustomMessagesProperty(String name, PropertyValueType propertyValueType) {
        this(name, new PropertyValueType[]{propertyValueType}, null);
    }

    private SectionCustomMessagesProperty(String name, PropertyValueType[] propertyValueTypes) {
        this(name, propertyValueTypes, null);
    }

    private SectionCustomMessagesProperty(String name, PropertyValueType propertyValueType, Class<? extends PropertySpecialValueType> sectionValueTypeClass) {
        this(name, new PropertyValueType[]{propertyValueType}, sectionValueTypeClass);
    }

    private SectionCustomMessagesProperty(String name, PropertyValueType[] propertyValueTypes, Class<? extends PropertySpecialValueType> sectionValueTypeClass) {
        this.name = name;
