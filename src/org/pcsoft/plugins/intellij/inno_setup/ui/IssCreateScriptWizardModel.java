...
public class IssCreateScriptWizardModel extends WizardModel {
    ...
    private static final class FileNameWizardStep extends WizardStep<IssCreateScriptWizardModel> {
        ...
        private final VerticalBox pnlPage = new VerticalBox();

        public FileNameWizardStep() {
            super("Script File Name", "Enter a script file name for file to create without extension", IssIcons.IS_SCRIPT_BIG);
            initUI();
        }
    ...
    private static final class UserDataWizardStep extends WizardStep<IssCreateScriptWizardModel> {
        ...
        public UserDataWizardStep() {
            super("Script User Data", "Enter all needed script data for the user to insert into the template.", IssIcons.IS_SCRIPT_BIG);
            initUI();
        }
        ...
        private void initUI() {
            ...
            pnlPage.setPreferredSize(new Dimension(600, 480));
            pnlPage.add(pnlAppName);
            pnlPage.add(pnlAppVersion);
            pnlPage.add(pnlAppPublisher);
            pnlPage.add(pnlAppPublisherUrl);
        }
    ...
    private static final class TechnicalDataWizardStep extends WizardStep<IssCreateScriptWizardModel> {
        ...
        public TechnicalDataWizardStep() {
            super("Script Technical Data", "Enter all needed script data for technical details to insert into the template.", IssIcons.IS_SCRIPT_BIG);
            initUI();
        }
        ...
        private void initUI() {
            ...
            pnlPage.setPreferredSize(new Dimension(600, 480));
            pnlPage.add(pnlBaseFilename);
            pnlPage.add(pnlOutputDir);
        }
