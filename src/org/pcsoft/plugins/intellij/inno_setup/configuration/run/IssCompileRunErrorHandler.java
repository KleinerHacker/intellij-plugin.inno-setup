 ...
 */
public final class IssCompileRunErrorHandler {
    ...
    private static void handleCodeLineError(Project project, String line) {
        ...
        if (!matcher.matches()) {
            Logger.getInstance(IssCompileRunErrorHandler.class).warn("Unable to parse error line");
            return;
        }
    ...
    private IssCompileRunErrorHandler() {
    }
}
