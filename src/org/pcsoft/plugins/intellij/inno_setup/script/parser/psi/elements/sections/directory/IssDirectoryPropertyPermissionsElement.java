 ...
 */
public class IssDirectoryPropertyPermissionsElement extends IssDefinitionPropertyElement<IssDirectoryDefinitionElement,IssDirectoryPropertyPermissionsValueElement,IssDirectoryProperty> {
    ...
    public IssDirectoryProperty getPropertyType() {
        return IssDirectoryProperty.Permissions;
    }
}
