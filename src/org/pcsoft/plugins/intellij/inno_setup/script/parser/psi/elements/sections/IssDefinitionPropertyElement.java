 ...
 */
public abstract class IssDefinitionPropertyElement<P extends IssDefinitionElement> extends IssAbstractElement {

    private final Class<P> clazz;

    public IssDefinitionPropertyElement(ASTNode node, Class<P> clazz) {
        super(node);
        this.clazz = clazz;
    }
