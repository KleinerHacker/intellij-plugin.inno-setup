 ...
 */
public class IssTaskDefinitionComponentsElement extends IssDefinitionItemElement<IssFileDefinitionElement>{

    public IssTaskDefinitionComponentsElement(ASTNode node) {
        super(node, IssFileDefinitionElement.class);
    }

    @NotNull
    public Collection<IssTaskDefinitionComponentsValueElement> getComponentsValueList() {
        return PsiTreeUtil.findChildrenOfType(this, IssTaskDefinitionComponentsValueElement.class);
    }
}
