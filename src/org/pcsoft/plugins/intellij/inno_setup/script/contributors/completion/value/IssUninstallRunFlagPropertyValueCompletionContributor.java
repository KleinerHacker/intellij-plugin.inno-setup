 ...
 */
public class IssUninstallRunFlagPropertyValueCompletionContributor extends IssAbstractPropertyValueCompletionContributor<IssPropertyUninstallRunFlagsElement> {
    public IssUninstallRunFlagPropertyValueCompletionContributor() {
