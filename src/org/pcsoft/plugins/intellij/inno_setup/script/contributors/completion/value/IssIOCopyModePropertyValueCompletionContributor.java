 ...
 */
public class IssIOCopyModePropertyValueCompletionContributor extends IssAbstractPropertyValueCompletionContributor<IssPropertyIOCopyModeElement> {
    public IssIOCopyModePropertyValueCompletionContributor() {
