 ...
 */
public class IssSectionComponentCompletionContributor extends CompletionContributor {
    public IssSectionComponentCompletionContributor() {
        extend(CompletionType.BASIC,
                PlatformPatterns.psiElement().withLanguage(IssLanguage.INSTANCE).inside(IssComponentSectionElement.class).afterLeaf(";", "\n", "\r", "\r\n"),
                new CompletionProvider<CompletionParameters>() {
                    @Override
                    protected void addCompletions(CompletionParameters completionParameters, ProcessingContext processingContext, CompletionResultSet completionResultSet) {
                        for (final IssComponentAttribute item : IssComponentAttribute.values()) {
