 ...
 */
public class IssDirectoryFlagPropertyValueCompletionContributor extends IssAbstractPropertyValueCompletionContributor<IssPropertyDirectoryFlagsElement> {
    public IssDirectoryFlagPropertyValueCompletionContributor() {
