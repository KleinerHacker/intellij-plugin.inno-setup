 ...
 */
public class IssIconFlagPropertyValueCompletionContributor extends IssAbstractPropertyValueCompletionContributor<IssPropertyIconFlagsElement> {
    public IssIconFlagPropertyValueCompletionContributor() {
