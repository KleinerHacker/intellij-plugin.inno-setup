 ...
 */
public class IssFileFlagPropertyValueCompletionContributor extends IssAbstractPropertyValueCompletionContributor<IssPropertyFileFlagsElement> {
    public IssFileFlagPropertyValueCompletionContributor() {
