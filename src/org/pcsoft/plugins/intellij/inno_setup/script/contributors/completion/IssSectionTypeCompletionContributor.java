 ...
 */
public class IssSectionTypeCompletionContributor extends CompletionContributor {
    public IssSectionTypeCompletionContributor() {
        extend(CompletionType.BASIC,
                PlatformPatterns.psiElement().withLanguage(IssLanguage.INSTANCE).inside(IssTypeSectionElement.class).afterLeaf(";", "\n", "\r", "\r\n"),
