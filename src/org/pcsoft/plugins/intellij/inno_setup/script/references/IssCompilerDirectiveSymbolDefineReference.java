 ...
 */
public class IssCompilerDirectiveSymbolDefineReference extends IssAbstractReference {

    public IssCompilerDirectiveSymbolDefineReference(PsiNamedElement element, boolean strictSearch) {
    ...
    public ResolveResult[] multiResolve(boolean b) {
        final Collection<IssCompilerDirectiveSymbolDefineSectionElement> compilerDirectiveSectionElements = IssFindUtils.findCompilerDirectiveSymbolSectionElements(myElement.getProject(), key, b);
    ...
    public Object[] getVariants() {
        final Collection<IssCompilerDirectiveSymbolDefineSectionElement> compilerDirectiveSectionElements = IssFindUtils.findCompilerDirectiveSymbolSectionElements(myElement.getProject());
    ...
    public boolean isReferenceTo(PsiElement element) {
        if (element instanceof IssCompilerDirectiveIdentifierParameterElement &&
                PsiTreeUtil.getParentOfType(element, IssCompilerDirectiveSymbolDefineSectionElement.class) != null) {
