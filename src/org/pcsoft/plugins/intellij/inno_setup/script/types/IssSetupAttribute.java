 ...
 */
public enum IssSetupAttribute implements IssSectionIdentifier {
    //Compiler
    ...
    public static IssSetupAttribute fromId(final String id) {
        return IssSectionIdentifier.fromId(id, IssSetupAttribute.class);
    }

    public static IElementType getMarkerElementFromId(final String id) {
        return IssSectionIdentifier.getItemMarkerElementFromId(id, IssSetupAttribute.class);
    }

    private final String id, type;
    private final IElementType itemMarkerElement;

    private IssSetupAttribute(String id, IElementType itemMarkerElement, String type) {
        this.id = id;
        this.type = type;
