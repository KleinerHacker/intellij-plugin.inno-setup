...
public enum IssSetupProperty implements IssPropertyIdentifier {
    ...
    AppId("AppId", IssMarkerFactory.SetupSection.PROPERTY_APPID, IssMarkerFactory.SetupSection.PROPERTY_APPID_VALUE,
            IssSetupPropertyClassifier.Installer, "setup.property.appid"),
