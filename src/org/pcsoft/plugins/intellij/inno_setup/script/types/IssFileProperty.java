...
public enum IssFileProperty implements IssDefinableSectionIdentifier {
    ...
    DestinationName("DestName", IssMarkerFactory.FileSection.ITEM_DESTNAME, IssMarkerFactory.FileSection.ITEM_DESTNAME_VALUE, "property.files.dest_name"),
    Excludes("Excludes", IssMarkerFactory.FileSection.ITEM_EXCLUDES, IssMarkerFactory.FileSection.ITEM_EXCLUDES_VALUE, "property.files.excludes"),
    ExternalSize("ExternalSize", IssMarkerFactory.FileSection.ITEM_EXTERNALSIZE, IssMarkerFactory.FileSection.ITEM_EXTERNALSIZE_VALUE, "property.files.external_size"),
    ...
    FontInstall("FontInstall", IssMarkerFactory.FileSection.ITEM_FONTINSTALL, IssMarkerFactory.FileSection.ITEM_FONTINSTALL_VALUE, "property.files.font_install"),
    StrongAssemblyName("StrongAssemblyName", IssMarkerFactory.FileSection.ITEM_STRONGASSEMBLYNAME, IssMarkerFactory.FileSection.ITEM_STRONGASSEMBLYNAME_VALUE, "property.files.strong_assembly_name"),
