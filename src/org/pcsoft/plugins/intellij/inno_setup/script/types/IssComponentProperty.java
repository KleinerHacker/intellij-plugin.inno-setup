 ...
 */
public enum IssComponentProperty implements IssDefinablePropertyIdentifier {
    ...
    private IssComponentProperty(final IssDefinablePropertyIdentifier sectionIdentifier) {
