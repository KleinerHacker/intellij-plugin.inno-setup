 ...
 */
public enum IssCompilerDirectiveSymbolUndefineParameterType implements IssCompilerDirectiveParameterIdentifier {
    ...
    private IssCompilerDirectiveSymbolUndefineParameterType(String name, IElementType elementType, int orderNumber) {
        this(name, elementType, orderNumber, null);
    }

    private IssCompilerDirectiveSymbolUndefineParameterType(String name, IElementType elementType, int orderNumber, Predicate<String> parameterCheck) {
        this.name = name;
