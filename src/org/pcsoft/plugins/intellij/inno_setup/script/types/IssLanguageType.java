...
public enum IssLanguageType {
    ...
    SerbianCyrillic("Serbian Cyrillic", "Languages\\vSerbianCyrillic.isl", IconLoader.findIcon("icons/lan/rs.png")),
    SerbianLatin("Serbian Latin", "Languages\\SerbianLatin.isl", IconLoader.findIcon("icons/lan/rs.png")),
    Slovenia("Slovenia", "Languages\\Slovenia.isl", IconLoader.findIcon("icons/lan/si.png")),
