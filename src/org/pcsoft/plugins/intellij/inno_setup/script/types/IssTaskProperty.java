...
public enum IssTaskProperty implements IssDefinableSectionIdentifier {
    ...
    DescriptionGroup("GroupDescription", IssMarkerFactory.TaskSection.ITEM_GROUPDESCRIPTION, IssMarkerFactory.TaskSection.ITEM_GROUPDESCRIPTION_VALUE, "property.tasks.group_description"),
