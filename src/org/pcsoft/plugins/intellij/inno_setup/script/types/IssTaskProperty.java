...
public enum IssTaskProperty implements IssDefinableSectionIdentifier {
    Name("Name", IssMarkerFactory.TaskSection.ITEM_NAME, IssMarkerFactory.TaskSection.ITEM_NAME_VALUE, "task.property.name"),
    Description("Description", IssMarkerFactory.TaskSection.ITEM_DESCRIPTION, IssMarkerFactory.TaskSection.ITEM_DESCRIPTION_VALUE, "task.property.description"),
    DescriptionGroup("GroupDescription", IssMarkerFactory.TaskSection.ITEM_GROUPDESCRIPTION, IssMarkerFactory.TaskSection.ITEM_GROUPDESCRIPTION_VALUE, "task.property.group_description"),
    Flags("Flags", IssMarkerFactory.TaskSection.ITEM_FLAGS, IssMarkerFactory.TaskSection.ITEM_FLAGS_VALUE, "task.property.flags"),
    Components("Components", IssMarkerFactory.TaskSection.ITEM_COMPONENTS, IssMarkerFactory.TaskSection.ITEM_COMPONENTS_VALUE, "common.property.components"),
    //Commons
