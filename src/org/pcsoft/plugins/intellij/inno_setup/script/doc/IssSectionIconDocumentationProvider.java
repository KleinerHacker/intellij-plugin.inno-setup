...
import org.pcsoft.plugins.intellij.inno_setup.script.parser.psi.elements.property.definable.IssPropertyIconFlagsValueElement;
    ...
    public String generateDoc(PsiElement element, PsiElement originalElement) {
        if (element instanceof IssIdentifierElement) {
            ...
            if (PsiTreeUtil.getParentOfType(element, IssIconDefinitionElement.class) != null) {
                final IssIconProperty iconProperty = IssIconProperty.fromId(identifierElement.getName());
