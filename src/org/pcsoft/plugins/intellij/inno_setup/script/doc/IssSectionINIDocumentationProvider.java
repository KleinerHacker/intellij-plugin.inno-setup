...
import org.pcsoft.plugins.intellij.inno_setup.script.parser.psi.elements.property.definable.IssPropertyINIFlagsValueElement;
    ...
    public String generateDoc(PsiElement element, PsiElement originalElement) {
        if (element instanceof IssIdentifierElement) {
            ...
            if (PsiTreeUtil.getParentOfType(element, IssINIDefinitionElement.class) != null) {
                final IssINIProperty iniProperty = IssINIProperty.fromId(identifierElement.getName());
                if (iniProperty == null)
