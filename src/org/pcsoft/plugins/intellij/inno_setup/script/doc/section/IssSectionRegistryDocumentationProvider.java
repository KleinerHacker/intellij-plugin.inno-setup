...
//        }
    ...
    public List<String> getUrlFor(PsiElement element, PsiElement originalElement) {
        if (element instanceof IssPropertyRegistryFlagsValueElement) {
    ...
    public String generateDoc(PsiElement element, PsiElement originalElement) {
        if (element instanceof IssIdentifierNameElement) {
            ...
            if (PsiTreeUtil.getParentOfType(element, IssRegistryDefinitionElement.class) != null) {
                final IssRegistryProperty registryProperty = IssRegistryProperty.fromId(identifierNameElement.getName());
